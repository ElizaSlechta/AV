...
namespace Avalonia.Styling
{
    ...
    public abstract class Selector
    {
        ...
        /// </summary>
        /// <param name="parent">The parent style, if the selector is on a nested style.</param>
        /// <remarks>
        /// The previous selector, and its parent style.
        /// </remarks>
        private protected abstract (Selector?, IStyle?) MovePrevious(IStyle? parent);
